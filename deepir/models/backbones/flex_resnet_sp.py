...
from .base_sp import BasicBlockSP, BottleneckSP, ResLayerSP_FlexResNet
### END MODIFIED ###


@DETBACKBONES.register_module()
@SEGBACKBONES.register_module()
class FlexResNetSP(nn.Module):
    ...
    def __init__(self,
        ...
        super(FlexResNetSP, self).__init__()
        ...
        if isinstance(pretrained, str):
            ...
            if init_cfg is None:
                ...
                if self.zero_init_residual:
                    if self.block is BasicBlockSP:
                        block_init_cfg = dict(
                            type='Constant',
                            val=0,
                            override=dict(name='norm2'))
                    elif self.block is BottleneckSP:
                        block_init_cfg = dict(
                            type='Constant',
                            val=0,
    ...
    def make_res_layer(self, **kwargs):
        ...
        return ResLayerSP_FlexResNet(**kwargs)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(FlexResNetSP, self).train(mode)
        self._freeze_stages()
